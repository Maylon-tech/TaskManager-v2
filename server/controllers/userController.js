...
const createToken = (userId) = jwt.sign({ id: iserId }, JWT_SECRET, { espieresIn: TOKEN_EXPIRES })
...
export const registerUser = async (req, res) => {
    ...
    try {
        // IF Already Registered on the Same Email.
        ...
        console.log(error)
        res.atatus(500).json({ success: false, message: "Server Error.!" })
    }
